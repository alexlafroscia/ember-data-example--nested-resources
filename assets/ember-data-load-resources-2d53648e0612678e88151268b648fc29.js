...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}})),runningTests||require("ember-data-load-resources/app").default.create({name:"ember-data-load-resources",version:"0.0.0+42d90328"})
